    ...
    if (FilePos(Pacs) <> 0) and (FilePos(Enfs) <> 0) then
      begin
        repeat
          ...
          //WriteLn('Ingrese el dia que ingreso (1 - 30).');
          //repeat
            //ReadLn(H.fecha_ingreso.dia);
          //until (H.fecha_ingreso.dia >= 1) and (H.fecha_ingreso.dia <= 30);

          //WriteLn('Ingrese el mes que ingreso (1 - 12).');
          //repeat
            //ReadLn(H.fecha_ingreso.mes);
          //until (H.fecha_ingreso.mes >= 1) and (H.fecha_ingreso.mes <= 12);

          //WriteLn('Ingrese el ano que ingreso (2000 - 2020).');
          //repeat
            //ReadLn(H.fecha_ingreso.ano);
          //until (H.fecha_ingreso.ano >= 2000) and (H.fecha_ingreso.ano <= 2020);
